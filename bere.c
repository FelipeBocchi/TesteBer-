#include <stdio.h>
#include <stdlib.h>  // funcos utilitarias como (malloc, free, exit, etc.)
#include <string.h>   // manipulacao de strings
#include <locale.h> // configurar o idioma e acentuação (setlocale)
#include <ctype.h> // funcoes como toupper()
#include <time.h>  // Trabalhar com data e hora
#include <math.h> // operacoes matemáticas como pow, sqrt
